...
import com.vishop.core.util.DateUtils;
...
public class MapContainer extends LinkedHashMap<String, Object> {
    ...
    private static final long serialVersionUID = 5902445079012759282L;
    ...
    private Date getAsDate(String key, String pattern) {
        return getAsDate(key, pattern, null);
    }

    private Date getAsDate(String key, String pattern, Date defaults) {
        Object value = get(key);
        if(value == null){
            return defaults;
        }
